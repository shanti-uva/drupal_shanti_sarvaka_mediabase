...
function sarvaka_mediabase_transcripts_ui_transcript_navigation($vars) {
	$out  = "<button type='button' class='btn btn-default btn-icon playpause' title='Play'><span class='icon shanticon-arrow-tri-right'></span></button>";
...
function sarvaka_mediabase_transcripts_ui_play_tcu($vars) {
        $mins = floor ($vars['element']['#time'] / 60);
        $secs = $vars['element']['#time'] % 60;
        $time = sprintf ("%d:%02d", $mins, $secs);
